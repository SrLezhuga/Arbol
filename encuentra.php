...
<head>
  ...
  <title>REFACCIONARIA ARBOLEDAS | Encuentra</title>
</head>
...
<body>
  <div id="wrapper">
    ...
    <div class="container menus rounded">
      <h2 class="mitr">ENCUENTRA TU REFACCIÓN</h2>
    </div>
    <section>
      <div class="col-12 text-center">
        <img src="assets/media/img/REFACCION.png" style="width: 25%; max-width: 25%;" onContextMenu='return false;' draggable='false'>
      </div>
      <div class="container bg-white border mb-3 mt-1">
        <!-- Auto -->
        <div class="row">
