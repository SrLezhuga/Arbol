...
<head>
  ...
  <title>REFACCIONARIA ARBOLEDAS | Cookies</title>
</head>
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <br>
                  <h4 class="mitr">COOKIES DE TERCEROS</h4>
                  <div class="separator-top"></div>
                  <p class="text-justify">
                  ...
                  <br>
                  <h4 class="mitr">CÓMO GESTIONAR LAS COOKIES DESDE EL NAVEGADOR</h4>
                  <div class="separator-top"></div>
                  <p class="text-justify">
                    <b>Eliminar las cookies del dispositivo</b>
                  ...
                  <br>
                  <h4 class="mitr">CÓMO ELIMINAR LAS COOKIES DE LOS NAVEGADORES MÁS COMUNES</h4>
                  <div class="separator-top"></div>
                  <p class="text-justify">
