        ...
        <div class="container-fluid p-0 m-0">
            <div class="row g-0 justify-content-md-center align-items-center ">
                <div class="col text-end">
                    <a class="btn btn-outline-primary btn-portal mitr" href="#" role="button"><i class="fas fa-shopping-cart"></i></a>
                </div>
                ...
                <div class="col text-start">
                    <a class="btn btn-outline-primary btn-portal mitr" href="#" role="button"><i class="fas fa-shield-alt"></i></a>
                </div>
            </div>
        </div>
    </nav>
